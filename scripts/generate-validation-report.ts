...
${bullet([
  ...
  "**Subduction earthquakes are shaken with laws fitted to crustal ones, and slip on crustal rock.** The intensity rings use Joyner & Boore 1981 and the reported accelerations Boore et al. 2014, both for shallow crustal events; no subduction-interface relation is implemented, and Tōhoku's MMI IX band in the footprint table is where it shows. Every fault also slips on one rigidity, 30 GPa, where shallow megathrusts are softer (Bilek & Lay 1999) and slip further for the same magnitude.",
