...
version 2.1, as its code of conduct. The full text is reproduced below
for convenience.
...
standards. They have the right to remove, edit, or reject comments,
commits, code, wiki edits, issues, and other contributions that don't
align with this code, and will communicate the reasons when
appropriate.

## Scope

This code applies in all community spaces, and also when an individual
...
when determining the consequences of any action they deem in violation
of this code.
