...
| Fire ignition radius          | effects/firestorm.ts                | R s.t. Q(R) = Glasstone & Dolan Table 7.40, shredded newspaper (4, 6, 11 cal/cm² at 35 kt, 1.4 Mt, 20 Mt), log-yield                                                                                                           |
| Mass-fire radius              | effects/firestorm.ts                | R s.t. Q(R) = Table 7.40, douglas fir plywood (9, 16, 20), and π R² ≥ ½ square mile (§7.58), else 0                                                                                                                            |
