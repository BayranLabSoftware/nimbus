...
| Overpressure ring             | events/explosion/overpressure.ts    | ΔP/P₀ = 808[1+(Z/4.5)²]/√(…), Z = R/W^⅓ (free air)                                                                                                                                               | Kinney & Graham 1985 (as in Takazawa et al. 2023)                                     | ±15%              |
| Thermal fluence               | events/explosion/thermal.ts         | Q = f W τ / (4π R²), τ = e^(−R/L) (project L)                                                                                                                                                    | Glasstone & Dolan 1977 §7.94–7.96                                                     | ±25%              |
