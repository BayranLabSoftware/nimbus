...
| I2, I4 | I2 not met (see above). I4's counting clause measured on 16 September 2026 and missed — the ring count was up to 10.4 % from an exact count of the same cells on 20 km circles — then met: the edge cells are split 12 × 12 and the worst is 2.7 % (rules 94 to 97). The ceiling clause is unchanged, and the polygon counter is still unmeasured.                                                                                                                                                                                                                                                                    |
