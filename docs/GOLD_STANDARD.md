...
| ------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| E1     | score ≥ 0.50 (≥ 0.40 on finite-rupture or ten-station maps), sharpness ≤ 0.35  | a ShakeMap scenario run on its own ground-motion models without stations, scored the same way on the same maps                                                           | **not met, measured 20 September 2026** on 300 held-out ShakeMaps of a depth band and a window no earlier rule had read (rules 329 to 334): rule 28's score is 0.433 for the reference, 0.333 for us on one Vs30 and 0.088 for us with the ground at every point. We never miss an MMI VII (0 of 43) and paint one on 234 of the 257 maps that hold none, where the reference paints 10; the site term that fixes the area (bias 0.686× → 0.916×) is what makes the false alarms worse. The reference does not reach the written 0.50 either, which is recorded and lowers nothing                                                                                                                                                                                 |
...
| T1     | ×1.25 at the median event, σ_ln ≤ 0.50, ×1.5 beyond 7 000 km                   | GeoClaw on real bathymetry, on the same DART records                                                                                                                     | **met on the headline reading, 22 September 2026.** GeoClaw over the shipped bathymetry, five fine runs added overnight: on bracketed-2cm, 93 of 113 records across all nine events, which clears rule 210's floor. C0 (Nimbus) 1.01×, C2 (GeoClaw) 0.92×, scatter ln 0.435 against 0.439 — no worse than the reference, and that clause holds on all four readings. The two `covered` readings keep too few records for C2 to exist as a column (6 events, and 55 records), so they read "not met" on the REFERENCE's floor rather than on ours. Nineteen rows leave C2 because the two refinements disagree by more than 25 %: the limit on this campaign is GeoClaw's own convergence. Nothing is adopted and no coefficient is fitted to these rows (rule 213) |
...
| T1     | On the 113 DART records of BM-05, now read: 1.00× at the median event, σ_ln 0.44, 0.84× beyond 7 000 km. No held-out set. Against the reference, 22 September 2026: on the 93 of those records GeoClaw converges on, Nimbus reads 1.01× where GeoClaw reads 0.92×, at the same scatter — no worse than the field's own tool, on all four readings.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
