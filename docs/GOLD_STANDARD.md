...
| N1     | Not met: blast rings 1.09× NUKEMAP, overpressure 1.07× Kingery–Bulmash; radiation a project fit; height of burst set on Hiroshima; crater 0.40× to 0.80× NUKEMAP's radii. The burn clause is met since 16 September 2026: the exposures are the book's Figure 12.64, growing with the yield, not a fit of the project's (rules 80 to 84). |
| N2     | Not measured.                                                                                                                                                                                                                                                                                                                             |
...
- **16 September 2026, one clause of N1 met.** Rules 80 to 84 traced Glasstone
  & Dolan's Figure 12.64 from the public scan and adopted it: an explosion's
  burn rings are now drawn at the exposure the book gives for that yield,
  where they stood at three fixed numbers of the project's own. N1 asks that
  no fit of the project's stand in where the book gives a curve, and for the
  burns it no longer does. The rest of N1 is unchanged, and an impact still
  draws the project's fluences (docs/SCIENCE.md, "The exposure that burns,
  from the book's own figure").
