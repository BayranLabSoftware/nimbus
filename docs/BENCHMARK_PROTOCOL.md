...
| POS      | Every output of every hazard, asked whether it is POSSIBLE rather than whether it is right                | Seven physical invariants G5 does not read: rings nest, a wave fits in its water, a toll fits in its exposure, energy is conserved and fractions lie in [0,1], a crater is not deeper than it is wide, an airburst is in the air, nothing is negative. Same 5 000 scenarios a hazard, same seeds. Rules 548 to 554; `pnpm audit:invariants`                                                                                                                             | pass / fail                                                                                       |
| TOLL     | The casualty arithmetic, on synthetic people at 100 to the square kilometre                               | Five invariants of the estimate itself: a toll inside its exposure, a band containing its estimate, the parts summing to the whole, each band inside its own people, nothing negative. Rules 586 to 592; `pnpm audit:tolls`                                                                                                                                                                                                                                             | pass / fail                                                                                       |
| CONS     | Whether the numbers add up: what comes out against what went in                                           | Seven questions of accounting rather than geometry — ash landing no deeper than it erupted, a lahar depositing no more than its volume, the air getting no more energy than the body had, a seismic magnitude implying no more energy than the event had, an ejecta blanket holding no more rock than the crater lost, aftershocks releasing no more moment than the mainshock, and a fault slipping what a fault can slip. Rules 605 to 612; `pnpm audit:conservation` | pass / fail                                                                                       |
| UI       | The panel and report of every preset                                                                      | The same inputs through the physics in Node                                                                                                                                                                                                                                                                                                                                                                                                                             | exact to displayed precision                                                                      |

POS exists because of how B-084 was found: by accident, inside a round
measuring something else, after five days in which the invariant sweep had
walked past 278 waves taller than the water they were in. G5's clauses read
finiteness, area and the antipode, and a 594 m wave is a finite length. POS
asks the questions beside them, and found two more of the same kind the
night it was written — B-085 and B-086, in two other domains. It spends
nothing: no tile is read and no held-out row is touched, so it may be rerun
as often as it is useful.
