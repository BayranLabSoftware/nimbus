...
The conventions this project is built to: architecture, stack,
commands, review rules. Read it before your first contribution.
...
**BayranLabSoftware/nimbus**. Remaining placeholders before public
release:

- ~~Copyright holder placeholder~~ — resolved: `LICENSE` and `NOTICE`
  name the holder.
