...
export const VISUAL_CONTRACTS = {
  ...
  impactFieldMap: defineContract({
    ...
    caveats: [
      ...
      "the low overpressure (rule 1031 (c)) is the overpressure's own field read from 1 kPa up to 0.5 psi, where the structural layer starts, on a scale of its own, lines at 1 and 3 kPa: exploratory — not validated as a prediction of the field — and outside the structural scale and the toll",
