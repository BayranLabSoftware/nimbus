  ...
  },
  {
    ...
    rules: [
      ...
      },
      {
        ...
        status: 'met',
        evidence:
          "Read against the program's entry on the 357 CNEOS fireballs (rules 126 to 128, validation/fireballAnchorRules.ts). Rescored on 21 September 2026 when the entry went back to Eq. 12's I_f (rules 691 to 697): 352 within 1 %, 4 through BM-13, 1 refused by the program, MET — the reading the rules were written on, since the model it scored was on the paper's I_f; on the program's I_f, the default from 16 to 21 September, the same script read NOT MET, having converted the model to the program's I_f twice.",
      },
      {
        rule: 'I3',
        measure: 'beyond',
