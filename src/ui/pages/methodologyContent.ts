  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        formula:
          'd = R⊕ · arccos(R⊕ / (R⊕ + R_f)); R_f = 0.002 · E^(1/3) (impact, Collins et al. 2005 eq. 32*), 2 · 100 · W^0.4 ft ≈ 61 · W^0.4 m (nuclear, Glasstone & Dolan 1977 §2.127)',
        description:
          "A fluence radius says how much heat would arrive with nothing in the way, and for an impact-scale fireball it runs around the planet — a 15 km stone has a third-degree radius of 27 000 km on a globe whose farthest point is 20 015 km away. Thermal radiation travels in straight lines, so burns and mass fire are cut where the fireball sets below the curve of the Earth. The Earth Impact Effects Program makes a similar cut — the fireball is wholly hidden once the Earth’s curvature, (1 − cos Δ)·R⊕, exceeds its radius, with a partial-visibility factor before that (Collins et al. 2005). The nuclear radius is the maximum Glasstone & Dolan give, twice the breakaway radius of 100·W^0.4 ft (§2.127), and the same fireball the globe draws. A 200 km fireball is seen to 1 590 km; Hiroshima's to 48 km, so no nuclear scenario is touched. Heat does reach the far side, from rock re-entering everywhere at once (the cascade says so at +30 min), but that is a diffuse bath where shelter decides and not a flash where sightlines do: it is described, drawn, and deliberately not converted into deaths — Goldin & Melosh 2009 argue the ejecta shield their own radiation enough that the global firestorm may fizzle.",
        citation: collins2005,
      },
      {
