  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        description:
          'The thermal energy spread over a sphere, as Glasstone & Dolan write it (§7.94–7.96). The partition f is 0.35 for a nuclear air burst (Table 7.88) and 0.18 for a contact surface burst (§7.101); the book interpolates between the two for bursts in between (Table 7.101), and Nimbus does so linearly in height up to 200·W^0.4 ft, the height of the book’s air-burst curves (§7.42). The exposure that burns is the book’s own, read off its Figure 12.64 — “the radiant exposure required to produce skin burns for different skin pigmentations”, growing with the yield because a larger explosion spreads its pulse over a longer time, at the middle of the figure’s three. That figure attaches no probability to a curve: the book’s next one, 12.65, draws the same thing as probabilities (50 % of an average exposed population on its solid lines, 18 % and 82 % on its broken ones) and is not read here. At 1 Mt the first-degree curve asks 3.32 cal/cm², below the 4.5-to-6 band in which §12.65 puts 18 % of an exposed population at second-degree burns and the rest at first. An impact takes a luminous efficiency of 3 × 10⁻³ (Collins et al. 2005) and keeps the project’s fixed 8 and 5 cal/cm²: the figure’s curves are a nuclear fireball’s pulse. A chemical charge radiates comparatively little (§1.23) and has no burn radii. The transmittance τ and its length L are a project calibration.',
        citation: glasstoneDolan1977,
      },
      {
        id: 'firestorm',
