...
const harkrider1974: Citation = {
  ...
  venue: 'Geophysical Journal of the Royal Astronomical Society 36 (1), 191–225',
...
export const METHODOLOGY_SECTIONS: MethodologySection[] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        formula:
          'D_fr = { 1.25 · D_tc                          (simple, Eq. 22*, D_tc ≤ 2.56 km)\n        max(1.17 · D_tc^1.13 / D_c^0.13, D_c) (complex, Eq. 27*, D_c = 3.2 km) }',
        description:
      ...
      },
      {
        ...
        formula:
          'M = 0.67 · log₁₀(E) − 5.87   (E in J; ±0.67 for efficiency 10⁻⁵–10⁻³) ;  E = (v_end / v₀)² · E_kinetic, at the ground',
        description:
          'Collins et al. 2005 Eq. 40*: the Gutenberg–Richter magnitude–energy relation applied to a seismic efficiency of 10⁻⁴ (Schultz & Gault 1975), which Collins et al. give a range of 10⁻⁵–10⁻³; Teanby & Wookey (2011) assumed 2 × 10⁻⁵ for Mars and Teanby (2015) suggested 5 × 10⁻⁴. E is the kinetic energy a body or its swarm brings to the ground. A complete airburst’s magnitude is read from the air that carries its blast, since 21 September 2026 (below); the Earth Impact Effects Program reads it from the kinetic energy the body keeps at its burst altitude, which falls as a body grows, and Nimbus did so from 16 September 2026 (Collins et al. give no seismic effects for airbursts; until then Nimbus gave an airburst none). The program prints no magnitude; its map draws the ranges of Mercalli III, V, VII, IX and XII, which lie where Eqs. 41*–43* bring M down to 3, 4, 6, 7 and 9 — with 1/42 and 1/208 for the printed 0.0238 and 0.0048, the distance of Eq. 43* in radians, and each equation in force to where it meets the next — and read back through that law, sixteen bodies it had not been asked about give Nimbus’s magnitude within 0.01 at all 45 of their rings (rules 154 to 157). M is an energy magnitude: reading 10⁻⁴·E as a seismic moment instead would put every impact ≈ 2.9 units lower, because an earthquake’s moment is about 2 × 10⁴ times the energy it radiates (Kanamori 1977).',
        citation: collins2005,
      },
      {
        id: 'airburst-seismic',
        name: 'Seismic magnitude of an airburst',
        formula:
          'M = max(Ms(W, z_b), 0.67 · log₁₀(10⁻⁴ · (1 − z_b / R) · E_kept) − 5.87) ;  W = E₀ · max(f, 1 − f),  R = 0.002 · E_kept^(1/3)',
        description:
          'A complete airburst shakes the ground through the air that carries its blast. Harkrider, Newton & Flinn (1974) computed the fundamental Rayleigh wave an explosion in the air sends through a continental and an oceanic Earth, for yields of 1 kt to 10 Mt at altitudes of 0.3 to 80 km, and printed its surface-wave magnitude Ms (their Table 4, read from the scan and checked against its own columns: two misprinted Ms and one blank cell are read by the two columns that agree). Nimbus reads Ms there for the blast yield W the airburst’s rings are drawn from, at its burst altitude, interpolated in altitude and in the logarithm of the yield — or, where it is larger, the relation above on the share 1 − z_b/R of the energy the body keeps that strikes the ground below its own fireball (Eq. 32*); and gives no magnitude where neither covers the burst. Since 21 September 2026 (rules 730 to 738): the program’s reading hardly grows with the energy, since in the pancake model a body 1 % larger bursts 159 m lower with about 3 % less of its energy kept — bodies of 8, 27 and 65 Mt at 20 km/s all read 4.49 to 4.50 by it. Tunguska reads 4.31 and Chelyabinsk 4.00, where their Rayleigh waves gave Ms about 5.0 (Ben-Menahem 1975) and 3.7 (Tauzin et al. 2013).',
        citation: harkrider1974,
      },
      {
        id: 'airburst',
        ...
        description:
          "Collins et al. 2005 Eqs. 8–20, with their constants: H = 8 km, ρ₀ = 1 kg/m³, C_D = 2, pancake factor f_p = 7, and, when no strength class is chosen, Y from the impactor's density (their Eq. 9). A body with I_f ≥ 1 never breaks and strikes the ground slowed by drag. A broken body spreads as a pancake (Chyba, Thomas & Zahnle 1993) of dispersion length l = L₀ sin θ √(ρᵢ / C_D ρ(z*)); if it reaches seven times its size above the ground it airbursts at z_b and digs no crater — unless z_b is below its own fireball’s radius, where the share of the energy it keeps that strikes the ground digs (see the transient crater) — otherwise the swarm strikes the ground at the speed Eqs. 17 and 20 leave it. The crater is dug at that speed, and the fraction of the energy that reaches the ground is (v_end / v₀)². The equations are the paper's as printed, since 21 September 2026 (rules 691 to 697): Eq. 12's I_f is the one whose Eq. 11 lands within 40 m of the altitude where the ram pressure first reaches the strength (Eq. 10). Against the Earth Impact Effects Program run by Collins et al., on a fixed grid of 81 impacts, they give every outcome the program gives and the same kind of crater, the breakup altitude within 1 %, the burst within 5 % and the speed at the ground within 4 %. The program takes I_f at twice Eq. 12's, so its bodies break and burst lower, and its Eq. 20 has no −3(l/H)² term, which slows a body that breaks low; Nimbus followed it from 16 September 2026, to its breakup and burst altitudes within 0.02 %, and left it because on twice the I_f a body breaks below the altitude where its ram pressure passed its strength, Sikhote-Alin's body does not break, and where the doubled I_f reaches 1 the program has no answer, so that a body a thousandth larger could break kilometres lower where the paper's equations took over. Until 14 September 2026 this was a classifier tuned on Tunguska and Chelyabinsk that burst in the air bodies of 100 m to 1 km the equations bring to the ground.",
        citation: collins2005,
      },
      {
      ...
      },
      {
        ...
        formula:
          'f_sea = (θ − sin θ cos θ) / π ,  θ = arccos(d / R_tc) for d < R_tc, f_sea = 0 beyond ;  h = mean depth of the water within R_tc, ≤ 200 m ;  A = f_sea · min(0.07 · D_w, h)',
        description:
          'An impact on land near a coast raises a wave only with the part of its transient crater that lies in the sea: the circular segment of the crater, of radius R_tc, beyond a straight shoreline at the shore distance d — half at the water’s edge, nothing when the crater stops short, never more than half (rules 267 to 273, 19 September 2026). The wave is the Earth Impact Effects Program’s for the water crater D_w, scaled by that segment and never taller than the water it rises in. That water is, since 22 September 2026, the mean depth of the water within the transient crater — read on a lattice of the disc, each point on the finest map that covers it and on the shoreline search’s own terms, capped at 200 m (rules 798 to 804) — where it used to be the nearest sea’s own cell, which is the segment’s shallowest edge: Chicxulub on New Orleans was handed the 1.17 m of the planetary mosaic’s cell under the city, and on Lisbon the Tagus’s 2.66 m for a crater that spans the Atlantic shelf. Before 19 September the fraction was the share of the ejecta landing beyond the shore, R₀/d (McGetchin, Settle & Head 1973), which raised a wave where the crater never touched the water. The ejecta’s own wave, the sea draining into a crater that encloses the coast and the air blast pushing on the water are not sized by anyone, and the model prints none of them. The wave then leaves from the points of the crater’s own sea deep enough for the solver to march (10 m), or, where there are none, from the one nearest deep water (rules 819 to 825); until 22 September 2026 it left, at the moment of impact, from the nearest deep water in every compass sector out to the ejecta’s reach — on the Yucatán from the Caribbean coast across the peninsula, on Tampa from the Atlantic side of Florida.',
        citation: collins2005,
      },
      {
      ...
      },
      {
        ...
        formula:
          'shock(p) = R_program(E_kinetic · max(gf, 1 − gf), z₁ = 0, p) for a body that reaches the ground ;  burn(Q): f(Δ) · η · gf · E / (2π Δ²) + η · (1 − gf) · E / (4π Δ²) = Q',
        description:
          'The blast of a body or swarm that reaches the ground is the Earth Impact Effects Program’s law read at the ground, since 21 September 2026 (rules 748 to 755): the Mach relation of Collins et al.’s Eq. 54 at z₁ = 0, its crossover r_x = 290 scaled metres, on the program’s own energy E · max(gf, 1 − gf) — the law a complete airburst meets as its burst altitude falls to zero. The program reads the same law at the altitude Eq. 18 gives, which lies below the ground, its crossover r_x = 290 + 0.65 z₁ shortened as a steeper entry puts that altitude deeper, so that a steeper impact blasts less; Nimbus drew that from 16 September 2026, within 1 % of the program on every point read. At the ground Meteor Crater’s rings reach 4.4 times as far — Kring (1997) put its flattened trees at 14 to 19 km by the same scaling — and Chicxulub’s 3 % farther. Until 16 September 2026 each shock ring was the larger of a surface burst of the ground-coupled energy and an airburst of the atmospheric yield, which rose with a steeper impact where the program falls and parted from it by a quarter to eight times. The flashes are two, for an observer on the ground: the fireball of the ground-coupled energy gf · E and the flash of the atmospheric yield (1 − gf) · E, with no gain for altitude. The two flashes add, and the ring lies where their sum reaches the burn’s exposure. The fireball on the ground radiates as the program computes it, into the half-space above the ground and dimmed by the share of it still above an observer’s horizon (Collins et al.’s Eq. 36*), which draws the program’s ignition rings within 1 % on sixteen bodies it had not been asked about; the flash in the air, which the program does not compute, keeps the project’s sphere. Until 16 September 2026 the fireball on the ground was a sphere too, and a burn ring took the larger of the two flashes rather than their sum.',
        citation: collins2005,
      },
      {
        id: 'ejecta-asymmetry',
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        formula:
          'nearestSea(local tile, planetary mosaic, click) → distance to the shore, floored at half the cell of the map that found it; shore depth = the water body the coupling reaches, at its own cell, ≤ 200 m — for an impact whose crater reaches the sea, the mean of the water within the crater (rules 798 to 804); basin depth = the median of the sea around, which the far field would travel on',
        description:
          "When a burst lands on a land cell near the coast (Beirut 2020 on Hangar 12, Castle Bravo on the Bikini reef), the simulator finds the nearest sea a wave could cross — not a lake or a river — and passes the burst its distance and depth, so the sea-coupling law can say whether the crater reaches the water. For an IMPACT on ground the answer changed on 19 September 2026 (rules 267 to 273): the wave’s source is the circular segment of the transient cavity that lies beyond the shoreline, (θ − sin θ cos θ)/π with θ = arccos(d/R) — half at the water’s edge, nothing when the cavity stops short, never more than half — and the crater keeps its whole energy, where before it was handed the shore’s own water column and lost a fifth of it to a sea it never touched. Where the cavity does not reach the water the model raises no wave at all. The ejecta still reach it, and a curtain of rock falling into the sea raises something; so does an ocean draining into a crater whose rim encloses the coast, which the deposits at Chicxulub and Lockne record as a resurge; so does the air blast pushing on the water. Nobody has published how big any of the three is, and the model prints none of them rather than a number it cannot justify. Two things about those two numbers, both corrected on 19 September 2026. The distance is floored at half the cell of the map that found it, because the planetary mosaic is 39 km to the cell and used to answer nought metres for any point within tens of kilometres of a coast (rules 241 to 247). And the depth is the water the coupling reaches, at its own cell, not the median of everything within fifty kilometres: that median came back over the 200 m cap on every coast on Earth, so a lagoon of two metres and an estuary of twenty were both handed the same shelf (rules 248 to 254). For an impact whose crater reaches the sea, the shore’s cell is only the landward edge of the segment the wave rises in, and since 22 September 2026 the wave rises in the mean of the water within the crater instead (rules 798 to 804); a burst keeps the shore’s cell. And for an impact, since the same day, every water cell of a sector is tried in turn and the planetary mosaic vouches for a connected body of water rather than a single cell, so that a bay narrower than a mosaic cell — Tokyo’s, San Francisco’s — is found where the city’s canals and the terrain’s artefacts used to exhaust the search (rules 812 to 818); a burst keeps the search as it was. The basin beyond keeps its own number, and the far field still travels on a default 4 000 m rather than on it. A wave needs more than that: Glasstone & Dolan's relations are for a burst within the water, and a burst on a quay or a reef is not one, so it makes none. A harbour wave at Beirut is therefore not drawn. Its validation row accepts anything from nothing to two metres, and the “about a metre” it describes has no source in this repository, so the row checks little.",
        citation: glasstoneDolan1977,
      },
    ],
  },
